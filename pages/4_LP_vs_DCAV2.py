...
if "user" in st.session_state:
    ...
    auth_manager.logout()  # Appel de la méthode logout pour gérer la déconnexion
...
# ===================================== VISIBLE SI PAS CONNECTE ==================================== # 
    ...
    if menu == "Connexion":
        ...
        if st.button("Se connecter"):
            ...
            if result:
                st.error(result)  # Si erreur de connexion
            else:
                st.session_state['user'] = username  # Si connexion réussie, on ajoute l'utilisateur à la session
    ...
    # S'inscrire
        ...
        if st.button("S'inscrire"):
            if password != confirm_password:
                ...
                error_message = auth_manager.register(username, password, email)
                if error_message:
