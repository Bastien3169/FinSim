...
indices = {
    "Nom_Indice": ['CAC40', 'DAX40', 'FTSE MIB40', 'IBEX35', 'BEL20', 'AEX25', 'FTSE100', 'SP500', 'NASDAQ100', 'DowJones30', 'OMX Helsinki 25', 'OMX Stockholm 30', 'OMX Copenhagen 25', 'STOXX50', 'NIKKEI225'],
    "Ticker": ['PX1', 'DAX', 'FTSEMIB', 'INDI', 'BEL20', 'AEX', 'UKX', 'GSPC', 'NDX', 'DJI', 'OMCH25', 'OMXS30', 'OMXC25', 'SX5E', 'NI225'],
    "Ticker_Yahoo_Finance": ['^FCHI', '^GDAXI', 'FTSEMIB.MI', '^IBEX', '^BFX', '^AEX', '^FTSE', '^GSPC', '^NDX', '^DJI', '^OMXH25', '^OMX', '^OMXC25', '^STOXX50E', '^N225'],
    "Pays": ['France', 'Germany', 'Italy', 'Spain', 'Belgium', 'Netherlands', 'United Kingdom', 'United States', 'United States', 'United States', 'Finland', 'Sweden', 'Danemark', 'Europe', 'Japan'],
...
df.to_csv("/Users/bastoch/ProjectFinance_alleger/data_csv/historique_indices/infos_indices.csv", index=False, encoding='utf-8')
