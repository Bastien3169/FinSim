...
def indices_page(go_to):
    ...
    infos_actif = datas_actif.get_infos_indices()


    # =============== Tire et navigation ================
    page_title("LES INDICES BOURSIERS", with_back_button=True, back_callback=go_to)
   ...
   # =============== Composition ================
    ...
    display_composition_section(datas_manager=datas_actif, liste_actifs=liste_actif,actif_default=ACTIF_DEFAULT, actif_type=ACTIF_TYPE)
